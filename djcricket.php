...
This script is based on Is It Up for Slack: https://github.com/mccreath/isitup-for-slack; mccreath@gmail.com
...
$genius_check = "https://api.genius.com/search?access_token=[access token]&q=".urlencode($text);
